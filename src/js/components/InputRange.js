...
export class InputRange extends BaseComponent {
    constructor({ parent, className, notify, value }) {
        ...
        this.setValue(value);
        this.valueBeforeMuted = localStorageManager.getItem(`valueBeforeMuted${this.getClassName()}`, this.getValue());
        this.isMuted = localStorageManager.getItem(`isMuted${this.getClassName()}`, false);
    }
    setValue(value) {
    ...
    toLocalStorage() {
        localStorageManager.setItem(`valueBeforeMuted${this.getClassName()}`, this.valueBeforeMuted);
